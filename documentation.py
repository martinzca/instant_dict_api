...
class Doc:
    ...
    def serve(self):
        ...
        jp.Div(a=div, text="Instant Dictionary API", classes="text-4xl p-2")
        jp.Div(a=div, text="Get definitions of words:", classes="text-xl m-2")
        jp.Hr(a=div)
        jp.Div(a=div, text="www.example.com/api?w=rain", classes="p-2")
        jp.Hr(a=div)
        jp.Div(a=div, text="""
